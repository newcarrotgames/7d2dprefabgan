...
(training_voxels, training_labels) = training_data.load()
print(training_voxels.shape)
training_voxels = training_voxels.reshape(
    training_voxels.shape[0], 16, 16, 16, 1).astype('float32')
print(training_voxels.shape)
# normalize the images to [-1, 1]
training_voxels = (training_voxels - 127.5) / 127.5
print(training_voxels.shape)
BUFFER_SIZE = 60000
BATCH_SIZE = 256
...
train_dataset = tf.data.Dataset.from_tensor_slices(
    training_voxels).shuffle(BUFFER_SIZE).batch(BATCH_SIZE)
