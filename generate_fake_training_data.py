...
def main():
    ...
    print("generating fake training data - dim: {}x{}, grid: {}x{}, cell dim: {}x{}, wall offsets: {}x{}"
        .format(w, h, grid_size, grid_size, cell_size, cell_size, cell_offset, cell_offset))
    ...
    for image_index in range(numer_of_images_to_generate):
        ...
        for grid_x in range(grid_size):
            for grid_y in range(grid_size):
                ...
                cv2.rectangle(data, (top, left),
                              (bottom, right), (0, 0, 255), 1)
